...
DATE: Wednesday, January 07, 2015     TIME: 3:02:19 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Wednesday, January 07, 2015 at 3:01:19 PM
...
/*   START OF NODE: Filter and Sort-age mini   */
%LET _CLIENTTASKLABEL='Filter and Sort-age mini';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\earobinson\Assignments\RobinsonE_SAS_project_0107.egp';
%LET _CLIENTPROJECTNAME='RobinsonE_SAS_project_0107.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.FILTER_FOR_MEPS_FULLYR_2012_SAS7);

PROC SQL;
   CREATE TABLE WORK.FILTER_FOR_MEPS_FULLYR_2012_SAS7 AS 
   SELECT t1.AGE12X, 
          t1.DUPERSID, 
          t1.SEX, 
          t1.REGION12, 
          ...
          t1.ADCMPY42, 
          t1.ADLANG42
      FROM EC100034.meps_fullyr_2012 t1
      WHERE t1.AGE12X > 17
...
/*   START OF NODE: Subset 1 Atr   */
%LET _CLIENTTASKLABEL='Subset 1 Atr';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\earobinson\Assignments\RobinsonE_SAS_project_0107.egp';
%LET _CLIENTPROJECTNAME='RobinsonE_SAS_project_0107.egp';
...
/*   START OF NODE: Filter and Sort - Sub Age 18-30   */
%LET _CLIENTTASKLABEL='Filter and Sort - Sub Age 18-30';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\earobinson\Assignments\RobinsonE_SAS_project_0107.egp';
%LET _CLIENTPROJECTNAME='RobinsonE_SAS_project_0107.egp';
...
PROC SQL;
   ...
   SELECT t1.AGE12X, 
          ...
          t1.ADCMPY42, 
          t1.ADLANG42
      FROM EC100029.meps_fullyr_2012 t1
      WHERE t1.AGE12X BETWEEN 18 AND 30
      ORDER BY t1.DUPERSID,
               t1.AGE12X;
QUIT;
...
/*   START OF NODE: Code For Sub2 Atr   */
%LET SYSLAST=WORK.FILTER_FOR_MEPS_FULLYR_2012_0001;
%LET _CLIENTTASKLABEL='Code For Sub2 Atr';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\earobinson\Assignments\RobinsonE_SAS_project_0107.egp';
%LET _CLIENTPROJECTNAME='RobinsonE_SAS_project_0107.egp';
%LET _SASPROGRAMFILE='P:\QAC\qac200\students\earobinson\Assignments\Assignment 3\Code For Sub2 Atr.sas';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Wednesday, January 07, 2015 at 2:38:34 PM
...
%_eg_conditional_dropds(WORK.CONTCONTENTSFORFILTER_FOR_M_0000);
TITLE "Data Set Sub 2 Attributes";
FOOTNOTE;
FOOTNOTE1 "Generated by the SAS System (&_SASSERVERNAME, &SYSSCPL) on %TRIM(%QSYSFUNC(DATE(), NLDATE20.)) at %TRIM(%SYSFUNC(TIME(), TIMEAMPM12.))";
PROC FORMAT;
   VALUE _EG_VARTYPE 1="Numeric" 2="Character" OTHER="unknown";
